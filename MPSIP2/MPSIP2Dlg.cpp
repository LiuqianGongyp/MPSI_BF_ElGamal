...
CMPSIP2Dlg::CMPSIP2Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MPSIP2_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMPSIP2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMPSIP2Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_OpenFile, &CMPSIP2Dlg::OnBnClickedOpenfile)
	ON_BN_CLICKED(IDC_Begin, &CMPSIP2Dlg::OnBnClickedBegin)
END_MESSAGE_MAP()


// CMPSIP2Dlg 消息处理程序

BOOL CMPSIP2Dlg::OnInitDialog()
{
...
void CMPSIP2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMPSIP2Dlg::OnQueryDragIcon()
{
...
void CMPSIP2Dlg::OnBnClickedOpenfile()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMPSIP2Dlg::OnBnClickedBegin()
{
	// TODO: 在此添加控件通知处理程序代码
	clock_t TStart, TEnd;
	double RunTime = 0;
