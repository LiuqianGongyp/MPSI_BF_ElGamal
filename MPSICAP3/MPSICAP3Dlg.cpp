...
CMPSICAP3Dlg::CMPSICAP3Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MPSICAP3_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMPSICAP3Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMPSICAP3Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_OpenFile, &CMPSICAP3Dlg::OnBnClickedOpenfile)
	ON_BN_CLICKED(IDC_Begin, &CMPSICAP3Dlg::OnBnClickedBegin)
END_MESSAGE_MAP()


// CMPSICAP3Dlg 消息处理程序

BOOL CMPSICAP3Dlg::OnInitDialog()
{
...
void CMPSICAP3Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMPSICAP3Dlg::OnQueryDragIcon()
{
...
void CMPSICAP3Dlg::OnBnClickedOpenfile()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMPSICAP3Dlg::OnBnClickedBegin()
{
	// TODO: 在此添加控件通知处理程序代码
	clock_t TStart, TEnd;
	double RunTime = 0;
