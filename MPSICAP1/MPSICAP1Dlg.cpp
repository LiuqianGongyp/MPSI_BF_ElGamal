...
CMPSICAP1Dlg::CMPSICAP1Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MPSICAP1_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMPSICAP1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMPSICAP1Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_OpenFile, &CMPSICAP1Dlg::OnBnClickedOpenfile)
	ON_BN_CLICKED(IDC_Begin, &CMPSICAP1Dlg::OnBnClickedBegin)
END_MESSAGE_MAP()


// CMPSICAP1Dlg 消息处理程序

BOOL CMPSICAP1Dlg::OnInitDialog()
{
...
void CMPSICAP1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMPSICAP1Dlg::OnQueryDragIcon()
{
...
void CMPSICAP1Dlg::OnBnClickedOpenfile()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMPSICAP1Dlg::OnBnClickedBegin()
{
	// TODO: 在此添加控件通知处理程序代码
	clock_t TStart, TEnd;
	double RunTime = 0;
	...
	ReceiveBits(party.ciphertext1, IPADdress[NumParty - 1]);
	ReceiveBits(party.ciphertext2, IPADdress[NumParty - 1]);
	//computation
	ZZ** T;
	T = new ZZ * [NumParty - 1];
